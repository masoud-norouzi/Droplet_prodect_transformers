...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the Markovian boundary-conditioned rollout Transformer control.")
...
def print_startup_banner() -> None:
    print("======================================")
    print("MARKOVIAN ROLLOUT EXPERIMENT")
    print(f"History length : {T_HISTORY}")
    print(f"Future rollout : {ROLLOUT_HORIZON}")
    print("======================================")
    print("Scientific goal: test whether [x, y, vx, vy, circularity] is sufficiently Markovian.")
...
def run_validation_smoke_test(model, optimizer, loader, dataset, normalization_stats, weights, device, output_dir) -> None:
    print("Running Markovian validation smoke test...")
    model.eval()
